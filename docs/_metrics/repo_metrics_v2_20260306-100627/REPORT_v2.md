...
Generated: 2026-03-06T09:06:39+00:00  
...
- Git-visible files: **138**
- Text files scanned: **93**
- Binary files scanned: **4**
- Engineering files: **64**
- Production files: **45**
- Python files: **50**
- Tracked code lines: **8663**
- Engineering code lines: **7603**
- Production code lines: **6661**
- Engineering comment density: **4.26%**
- Exact duplicate text groups: **0**
- Shadow duplicate pairs: **0**
- Quality issues emitted: **44**
- Tracked backup-like files: **1**
- Tracked generated/export candidates: **1**

## Scope Summary

| Scope | Files | Tracked | Code LOC | Doc lines | Comments | Binary | Churn | Avg risk |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| all_scanned | 97 | 97 | 8663 | 6134 | 344 | 4 | 20668 | 15.04 |
| docs_only | 24 | 24 | 0 | 6134 | 0 | 0 | 6929 | 0.94 |
| engineering_core | 64 | 64 | 7603 | 0 | 338 | 0 | 12652 | 22.38 |
| git_visible | 97 | 97 | 8663 | 6134 | 344 | 4 | 20668 | 15.04 |
| production_core | 45 | 45 | 6661 | 0 | 303 | 0 | 11109 | 27.36 |
| tests_only | 19 | 19 | 942 | 0 | 35 | 0 | 1543 | 10.59 |
| tracked_only | 97 | 97 | 8663 | 6134 | 344 | 4 | 20668 | 15.04 |
| workspace_noise | 5 | 5 | 903 | 0 | 0 | 4 | 903 | 0.00 |

## Repo Mix by Role

| Role | Files | Code LOC | Doc lines | Comments | Churn | Avg risk |
| --- | --- | --- | --- | --- | --- | --- |
| application | 23 | 4028 | 0 | 190 | 7154 | 33.02 |
| tooling | 13 | 1765 | 0 | 109 | 2239 | 28.19 |
| test | 19 | 942 | 0 | 35 | 1543 | 10.59 |
| data | 1 | 903 | 0 | 0 | 903 | 0.00 |
| template | 3 | 664 | 0 | 4 | 1468 | 28.94 |
| config | 6 | 204 | 0 | 0 | 248 | 3.07 |
| other | 4 | 157 | 0 | 6 | 184 | 0.86 |
...
| --- | --- | --- | --- | --- | --- | --- |
| src | 23 | 4028 | 0 | 7154 | 33.02 | 17694.60 |
| tools | 13 | 1765 | 0 | 2239 | 28.19 | 6450.83 |
| . | 17 | 1128 | 695 | 2071 | 0.77 | 109.34 |
| tests | 19 | 942 | 0 | 1543 | 10.59 | 1974.31 |
| templates | 3 | 664 | 0 | 1468 | 28.94 | 2884.43 |
| ontology | 11 | 94 | 4827 | 5375 | 2.14 | 94.70 |
...
| src/ontology_runtime.py | Python | application | 385 | 12 | 465 | 83.08 |
| templates/index.html | HTML | template | 369 | 4 | 686 | 40.55 |
| tools/project_audit_dump.py | Python | tooling | 350 | 26 | 446 | 56.47 |
| src/run_registry.py | Python | application | 311 | 6 | 407 | 55.81 |
| src/category_map.py | Python | application | 273 | 38 | 364 | 63.34 |
| tools/secret_scan.py | Python | tooling | 230 | 9 | 288 | 45.29 |
| tools/ontology_runtime_dump.py | Python | tooling | 214 | 4 | 263 | 38.10 |
| src/web_dashboard.py.bak | BAK | application | 212 | 0 | 262 | 31.69 |
| tests/test_api_v2_crud.py | Python | test | 169 | 4 | 417 | 26.86 |
| tools/project_data_snapshot.py | Python | tooling | 169 | 7 | 218 | 33.21 |
| templates/admin_item_edit.html | HTML | template | 167 | 0 | 444 | 26.71 |
| tools/handoff_make.py | Python | tooling | 167 | 10 | 204 | 36.06 |
| src/api_main.py | Python | application | 157 | 9 | 320 | 29.36 |
| src/db_schema.py | Python | application | 154 | 9 | 285 | 34.60 |
| tools/ingest_recover.py | Python | tooling | 145 | 8 | 184 | 40.38 |
| templates/item_detail.html | HTML | template | 128 | 0 | 338 | 19.56 |
| tools/handoff_snapshot.ps1 | PowerShell | tooling | 118 | 11 | 149 | 19.17 |
...
| src/ontology_runtime.py | Critical | 83.08 | 385 | 465 | 59.12 | low-maintainability; high-complexity-function; low-coverage; high-churn |
...
| src/category_map.py | High | 63.34 | 273 | 364 | 59.91 | low-maintainability; high-complexity-function; low-coverage; high-churn |
| tools/project_audit_dump.py | High | 56.47 | 350 | 446 | 0.00 | low-maintainability; high-complexity-function; missing-coverage-data; high-churn |
| src/run_registry.py | High | 55.81 | 311 | 407 | 71.21 | low-maintainability; high-complexity-function; high-churn |
| tools/secret_scan.py | Moderate | 45.29 | 230 | 288 | 0.00 | low-maintainability; high-complexity-function; missing-coverage-data; high-churn |
| templates/index.html | Moderate | 40.55 | 369 | 686 | 0.00 | missing-coverage-data; high-churn |
| tools/ingest_recover.py | Moderate | 40.38 | 145 | 184 | 0.00 | low-maintainability; high-complexity-function; missing-coverage-data; high-churn |
| tools/ontology_runtime_dump.py | Moderate | 38.10 | 214 | 263 | 0.00 | low-maintainability; high-complexity-function; missing-coverage-data; high-churn |
| tools/handoff_make.py | Moderate | 36.06 | 167 | 204 | 0.00 | high-complexity-function; missing-coverage-data; high-churn |
| src/db_schema.py | Low | 34.60 | 154 | 285 | 82.35 | high-churn |
| tools/project_data_snapshot.py | Low | 33.21 | 169 | 218 | 0.00 | missing-coverage-data; high-churn |
| src/web_dashboard.py.bak | Low | 31.69 | 212 | 262 | 0.00 | tracked-backup-file; missing-coverage-data; high-churn |
| src/api_main.py | Low | 29.36 | 157 | 320 | 70.77 | high-churn |
| tests/test_api_v2_crud.py | Low | 26.86 | 169 | 417 | 0.00 | low-maintainability; high-complexity-function; high-churn |
| templates/admin_item_edit.html | Low | 26.71 | 167 | 444 | 0.00 | missing-coverage-data; high-churn |
| tools/handoff_make_run.py | Low | 25.36 | 95 | 131 | 0.00 | missing-coverage-data; high-churn |
| src/check_db.py | Low | 24.97 | 40 | 57 | 0.00 | low-coverage |
